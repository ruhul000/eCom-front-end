...
@Component({
    ...
    styleUrls: ['./new-arival.component.css']
})
export class NewArivalComponent implements OnInit {
    ...
    constructor(private httpService: HttpService, public settingsService: SettingsService, public toastr: ToastsManager, vcr: ViewContainerRef, public layoutService: LayoutService, private router: Router, private activatedRouter: ActivatedRoute, public notificationsService: NotificationsService) {
    ...
    getProducts() {
        ...
        if (next) {
            const body = 'limit/NewArival?page=' + page.toString() + '&limit=' + this.pagination.limit.toString();
